...
-- =============================================
INSERT INTO Equipe (LibelleEquipe, IdSection, IdDoyenne)
SELECT
    :libelle,
...
AND NULLIF(:IdSection, '') IS NOT NULL
AND (
...
Dans la section ' || NomSection AS contents_md
FROM Section
...
LEFT JOIN SECTION sec ON sec.IdSection = equ.IdSection
...
AND sec.Idsection = sqlpage.cookie('IdSection')
ORDER BY doy.NomDoyenne, sec.NomSection, equ.LibelleEquipe;
-- =============================================
