select 
    ...
    JSON('{"title":"Administration","icon":"tool","submenu":[{"link":"/formalites.sql","title":"Modifier les formalités","icon":"book"},{"link":"/sacrements.sql","title":"Modifier les sacrements","icon":"list-details"}]}') as menu_item,
    'boxed'                     as layout,
    'fr-FR'                     as language;