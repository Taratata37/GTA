SELECT 
    ...
    CASE WHEN scn.IdDoyenne IS NULL THEN
        JSON('{"title":"Administration","icon":"tool","submenu":[{"link":"/admin/formalites.sql","title":"Modifier les formalités","icon":"book"},{"link":"/admin/sacrements.sql","title":"Modifier les sacrements","icon":"list-details"},{"link":"/admin/sections.sql","title":"Modifier les sections","icon":"list-details"},{"link":"/admin/def_mdp.sql","title":"Définir mdp","icon":"key"},{"link":"/admin/rgpd.sql","title":"Purge RGPD","icon":"user-off"}]}')
    END                         AS menu_item,
    'boxed'                     AS layout,
    'fr-FR'                     AS language
