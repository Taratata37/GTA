select 
    ...
    JSON('{"title":"Administration","icon":"tool","submenu":[{"link":"/admin/formalites.sql","title":"Modifier les formalités","icon":"book"},{"link":"/admin/sacrements.sql","title":"Modifier les sacrements","icon":"list-details"},{"link":"/admin/sections.sql","title":"Modifier les sections","icon":"list-details"}]}') as menu_item,
    'boxed'                     as layout,
    'fr-FR'                     as language;
