select 
    ...
    JSON('{"title":"Gestion","icon":"hexagons","submenu":[{"link":"/inscription.sql","title":"Inscription","icon":"edit"},{"link":"/presence.sql","title":"Feuille de présence","icon":"file-text"},{"link":"/formalites_manquantes.sql","title":"Formalités manquantes","icon":"file-report"},{"link":"/participants.sql","title":"Participants","icon":"file-text"}]}') as menu_item,
